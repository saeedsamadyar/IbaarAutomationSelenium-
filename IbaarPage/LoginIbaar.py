class Login:
    def __init__(self, driver):
        ...
        self.username_textbox_xpath = "//input[@type='password']"
        self.password_textbox_xpath = "//button[@type='submit']//span"
        self.submit_button_xpath = "//input[contains(@class,'jss1789 jss1773')]"
        self.driver = driver
